...
const authorizationReducer = (state = authInitialState, action: TAuthActions): TAuthState => {
    switch (action.type) {
        case LOGIN_REQUEST: {
        ...
        case RESET_SUCCESS: {
            return { ...state, resetPasswordRequest: false, resetPasswordSuccess: true };
        }
        case RESET_FAILED: {
        ...
        case FORGOT_SUCCESS: {
            return { ...state, forgotPasswordRequest: false, forgotPasswordFailed: false };
        }
        case FORGOT_FAILED: {
